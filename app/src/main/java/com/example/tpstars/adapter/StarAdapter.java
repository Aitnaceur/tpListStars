    ...
    public StarViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float currentRating = ((RatingBar) v.findViewById(R.id.stars)).getRating();
                bar.setRating(currentRating);

                String idText = ((TextView) v.findViewById(R.id.ids)).getText().toString();
                idss.setText(idText);
